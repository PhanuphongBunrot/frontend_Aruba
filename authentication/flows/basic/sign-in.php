...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link rel="shortcut icon" href="assets/media/logos/logoaruba-2.png" />
		<!--begin::Fonts-->
	...
	<body id="kt_body" class="bg-white">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/progress-hd.png)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
						...
						<img alt="Logo" src="assets/media/logos/logoaruba-2.png" class="h-200px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
		...
		<!--<script src="assets/plugins/global/plugins.bundle.js"></script>--><!-- ตัวเช็ค -->
		<!-- <script src="assets/js/scripts.bundle.js"></script>ตัวเช็ค -->
